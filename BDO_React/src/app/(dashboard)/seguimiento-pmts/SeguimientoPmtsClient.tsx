...
export default function SeguimientoPmtsClient({
  pmts,
  rol: _rol,
}: {
  pmts: PmtRow[];
      ...
      <RecordList
        ...
        renderDetail={(r) => (
          <div className="p-4 grid grid-cols-2 gap-2 text-sm">
            <span>
              <b>Número PMT:</b> {r.numero_pmt}
            </span>
            <span>
              <b>Tramo:</b> {r.tramo ?? '—'}
            </span>
            <span>
              <b>Fecha inicio:</b> {r.fecha_inicio ?? '—'}
            </span>
            <span>
              <b>Fecha fin:</b> {r.fecha_fin ?? '—'}
            </span>
            <span>
              <b>Responsable:</b> {r.responsable ?? '—'}
            </span>
