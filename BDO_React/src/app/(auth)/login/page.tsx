        ...
        <div style={{ minHeight: '100vh', display: 'flex', fontFamily: ff }}>
          ...
          >
            ...
            <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
              <Image
                src="/blueprint-bg.jpg" // Asegúrate de guardar la imagen en la carpeta public
                alt="Fondo de construcción estilo blueprint"
                fill
                style={{ objectFit: 'cover', objectPosition: 'center' }}
                priority
              />
              {/* Overlay sutil para oscurecer un poco la imagen y asegurar que el texto sea legible */}
              <div 
                style={{
                  position: 'absolute',
                  inset: 0,
                  background: 'linear-gradient(135deg, rgba(6,21,38,0.2) 0%, rgba(6,21,38,0.6) 100%)',
                  pointerEvents: 'none',
                }}
              />
            </div>
            ...
            <m.div
              ...
              transition={{ duration: reducedMotion ? 0 : 1.8, delay: 0.5 }}
            >
              <m.h1
                style={{
                  fontSize: 96,
                ...
                transition={{ duration: reducedMotion ? 0 : 1.8, delay: 0.8 }}
              >
                BOB
              </m.h1>
          ...
          <m.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: reducedMotion ? 0 : 1.2, delay: 0.5 }}
          >
            {/* Subtle dot pattern */}
            <div
              aria-hidden
            ...
            <div style={{ width: '100%', maxWidth: 432, position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ textAlign: 'center', marginBottom: 30 }}>
                <span
                  style={{
                    ...
                    textTransform: 'uppercase',
                    fontFamily: ff,
                    boxShadow: '0 4px 14px rgba(11,42,74,0.15)',
                  }}
                >
              ...
              <m.div
                style={{
                  ...
                  padding: '42px 44px',
                  boxShadow:
                    '0 2px 4px rgba(0,0,0,0.02), 0 12px 40px rgba(11,42,74,0.06), 0 2px 8px rgba(11,42,74,0.04)',
                  border: '1px solid rgba(11,42,74,0.06)',
                }}
                initial={{ opacity: 0, y: 18 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: reducedMotion ? 0 : 1.2, delay: 0.55 }}
              >
                {/* Card header */}
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          background: '#F4F6F8',
                          border: `1px solid ${errors.email ? '#fca5a5' : 'rgba(11,42,74,0.08)'}`,
                          borderRadius: 11,
                          fontSize: 14,
                          color: '#0B2A4A',
                          outline: 'none',
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          background: '#F4F6F8',
                          border: `1px solid ${errors.password ? '#fca5a5' : 'rgba(11,42,74,0.08)'}`,
                          borderRadius: 11,
                          fontSize: 14,
                          color: '#0B2A4A',
                          outline: 'none',
